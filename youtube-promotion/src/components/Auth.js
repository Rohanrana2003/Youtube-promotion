...
const Auth = ({ onAuthSuccess }) => {
  ...
  return (
    <div className=" pt-24 flex justify-center pb-5 h-[110vh] z-50">
      ...
      <div className="flex justify-center items-center gap-28">
        ...
        <p className='w-[600px] font-bold text-white text-6xl leading-[75px] -ml-10'>
        ...
        <form onSubmit={handleAuth}
          className="bg-black bg-opacity-70 w-[250px] sm:w-[338px]  p-6 px-10 rounded shadow-black shadow-md">

          <h1 className="text-[30px] w-full -ml-2 text-center after:flex after:mx-auto after:w-[100%] after:-mr-[7px] after:bg-slate-700 after:h-p font-semibold mb-4 text-slate-100">{isSignUp ? 'Sign Up' : 'Log In'}</h1>
          {isSignUp
            &&
            <input
              type="text"
              ...
              className="block focus:outline-none focus:shadow-[#D88B0F] focus:shadow-custom border border-gray-600 focus:border-transparent w-full p-[10px] pl-[14px] mb-2 text-white rounded focus:bg-opacity-100 bg-opacity-70 bg-[#1A1F27] "
            />
          }
          <input
            type="text"
          ...
          <input
            ...
            className="block  p-[10px] border w-full mb-1 pl-[14px] focus:outline-none focus:shadow-[#D88B0F] focus:shadow-custom text-white border-gray-600 focus:border-transparent rounded focus:bg-opacity-100 bg-opacity-70 bg-[#1A1F27] "
          />
          {
            error ?
          ...
          <button type="submit" className="bg-[#D88B0F] hover:opacity-85  text-white font-semibold py-2 px-4 rounded w-full">
          ...
          <button type="button"
            ...
            className="text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 me-2 mb-2
                      ...
                      px-14 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 ">
            {googleIcon}
            Sign in with Google
          </button>
